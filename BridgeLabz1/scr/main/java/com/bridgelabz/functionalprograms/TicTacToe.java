...
/**
 * Cross Game or Tic­Tac­Toe Game:A Program to play a Cross Game or Tic­Tac­Toe Game. Player 1 is
 *                                the user and the Player 2 is the computer. Player 2 take Random Cell that is the
 *                                Column and Row.
 *      After everytime either the user or computer enter the value display the game  keyboard on screen  
 *      if either the user or computer forming a  straight line in anyway possible meeting three input of similar type
 *      on screen the he will win
 *      @author LOKESH NAIK                     
 * */
...
n=UtilityScanner.integerInput();// Taking input from user
arr[n - 1] = 'X';
boardDisplay(arr);
}
